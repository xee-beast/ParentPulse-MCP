...
class GoodQuestions extends Component
{
    ...
    public function getAnswersProperty(): Collection
    {
        ...
        $answers = $answers->having('score', '>', '0')
        ->orderByDesc('score')
        ->limit(3)
        ->get();
    ...
    public function getTitleProperty(): string
    {
        return match ($this->period) {
            PeriodScope::ALL_TIME          => 'Here are your highest scores all-time',
            PeriodScope::LAST_365_DAYS     => 'Here are your highest scores over the past 365 days',
            PeriodScope::LAST_THREE_MONTHS => 'Here are your highest scores over the past three months',
            PeriodScope::LAST_THIRTY_DAYS  => 'Here are your highest scores over the past 30 days.',
            PeriodScope::TODAY             => 'Here are your highest scores over the past day',
            PeriodScope::Custom             => 'Here are your highest scores over the custom date range',
            default                        => '',
    ...
    {
        return view('livewire.tenant.home.good-questions');
    }
}
